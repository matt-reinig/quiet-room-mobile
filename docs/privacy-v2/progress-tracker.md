...
| 12 Policy site/account deletion update | `codex/privacy/task-12-policy-site` | — | `../worktrees/quiet-room-mobile-task-12-policy-site` | Codex | in progress | data inventory and public privacy/account-deletion site copy refreshed from implemented account deletion, AI consent, and 90-day operational-log retention behavior | — | public `/privacy`, `/account-deletion`, and `/support` copy now point to the profile icon deletion flow, concrete support path, OpenAI sharing/consent behavior, and log retention/deletion exceptions |
