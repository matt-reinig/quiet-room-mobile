...
const buildDebug = `cd android && ${gradlew} :app:assembleDebug :app:assembleDebugAndroidTest -DtestBuildType=debug`;
const buildRelease = `cd android && ${gradlew} :app:assembleRelease :app:assembleReleaseAndroidTest -DtestBuildType=release`;
